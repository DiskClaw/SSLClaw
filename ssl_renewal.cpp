...
extern void SaveDnsConfigForDomain(const std::wstring& domain);
...
extern std::wstring DnsCreateTxtRecord(int provider, const std::wstring& apiId, const std::wstring& apiSecret,
    const std::wstring& domain, const std::wstring& subDomain, const std::wstring& value);
extern std::wstring DnsDeleteTxtRecord(int provider, const std::wstring& apiId, const std::wstring& apiSecret,
...
extern std::string B64Url(const std::vector<BYTE>& d);
...
std::wstring GetRenewalIniPathPublic() { return GetRenewalIniPath(); }
